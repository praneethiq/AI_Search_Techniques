...
int[][] loc8 = new int [][] {	
	...
	public void searchExecution(int[][] inputmapchoice, int[][] inputlocchoice,Scanner sc1)
	{
		...
		int execrunstate=-1;
		   ...
		   System.out.println();
		   System.out.print("Select Search Algorithm: 1)A*Search using Manhattan 2)A*Search using Euclidean 3)Compare Both 4)Exit: ");
	       ...
	       case 1:   
	    	   aStarFirstSearch0(inputmapchoice,inputlocchoice);
	    	   System.out.println();
	    	   System.out.print("\nSelect Search Algorithm: 1)A*Search using Manhattan 2)A*Search using Euclidean 3)Compare Both 4)Exit: ");
	...
	public void aStarFirstSearch0(int[][] map,int[][] loc)
	{   
		...
		while(!frontier.isEmpty())
		{
			...
			System.out.print("\nIteration "+currentiteration+": ");
			 ...
			 nodelist=expandAFS0(currentnode, goalnode, map, loc, frontier, explored);
...
class Node implements Comparable<Node>
{
	...
	public int stateToIndex(char state)
	{
	 ...
	 public Node makeNodeAFS0(char state, Node pn,int[] loc,Node gn)
	{
		Node n= new Node();
		n.state= state;
		n.parentnode=pn;
		...
		{
			n.heuristiccost=(Math.abs(gn.x-n.x)  + Math.abs(gn.y-n.y))+(pn.pathcost+Math.sqrt( (Math.pow((pn.x-n.x),2) ) + Math.pow((pn.y-n.y),2)));
			depth=n.depth+1;
	 ...
	 public ArrayList<Node> expandAFS0(Node n1, Node gn, int[][] map, int[][] loc, PriorityQueue<Node> inputFrontier,char[] inputExplored)
	 {
		 ...
		 for(int i=0;i<map[currentlocation].length;i++)
			{
			 ...
			 if(map[currentlocation][i]==5&&(!checkPQueue(inputFrontier,i)&&(!checkArray(inputExplored,i))))
				 nodes.add(makeNodeAFS0(indexToState(i),n1,loc[i],gn));
			  ...
			  for(int i=0;i<inputmap.length;i++)
			   	 {
			   		 if(inputmap[i][i]==2)
			   		 {
			   			 n1=makeNodeAFS0(indexToState(i),null,loc[i],gn);
			   		 }
			   	 }
				 return n1;
			  ...
			  for(int i=0;i<inputmap.length;i++)
			   	 {
			   		 if(inputmap[i][i]==8)
			   		 {
			   			 n1=makeNodeAFS0(indexToState(i),null,loc[i],null);
			   		 }
			   	 }
				 return n1;
